...
// ENGINE STRUKTUR DATA (HASH TABLE)
class HashEngine {
private:
...
bool muatDariDataset(HashEngine& engine, const string& sumberFile, const string& fileDatabase) {
    auto start = steady_clock::now();
...
void insertManual(HashEngine& engine, const string& fileDatabase, const string& namaStruktur) {
    DataArsip d;
...
void updateDeleteData(HashEngine& engine, const string& fileDatabase) {
    string id;
...
void tampilkanStatistik(HashEngine& engine, const string& statsLogFile, const string& namaStruktur) {
    cout << "\n========== STATISTIK DATABASE ==========\n";
    int total, unik, grupDup, recordDup;
    double waktuMs;
...
void clearDatabase(HashEngine& engine, const string& fileDatabase) {
...
int main() {
    HashEngine engine;
    const string fileDatabase = "hash_database.csv";
    const string statsLogFile = "statistik_log.csv";
    const string namaStruktur = "Hash Table";
